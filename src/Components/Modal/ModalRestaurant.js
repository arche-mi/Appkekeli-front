...
export default function ModalRestaurant({state}) {
    return (
        <div>
            {/* <!-- Modal --> */}
            <div className="modal fade" id="ModalRestaurant" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="false">
                <div className="modal-dialog modal-lg-site modal-dialog-centered modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Informations sur le restaurant</h1>
                                    ...
                                    <div id={`Modal${state}`} className="carousel slide">
                                        ...
                                        <div className="carousel-inner" >
                                            <div className="carousel-item active">
                                                <img className='card-img card-img-top card-img-site' id="imgsrcRest1" alt='banco1' width='' height='' style={{ filter: "brightness(70%)" }} />
                                            </div>
                                            <div className="carousel-item">
                                                <img className='card-img card-img-top card-img-site' id="imgsrcRest2" alt='banco2' width='' height='' style={{ filter: "brightness(70%)" }} />
                                            </div>
                                            <div className="carousel-item">
                                                <img className='card-img card-img-top card-img-site' id="imgsrcRest3" alt='banco2' width='' height='' style={{ filter: "brightness(70%)" }} />
                                            </div>
                                        </div>
