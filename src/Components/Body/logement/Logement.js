            ...
            <div className="card shadow-sm rounded-3">
              ...
              <div className="card-body">
                <ul className="list-group list-group-flush">
                  <li className="list-group-item">Type : Residence</li>
                  <li className="list-group-item">Chambres : 3</li>
                  <li className="list-group-item">Lit :4</li>
                  <li className="list-group-item">Prix: 20$</li>
                ...
                <div className="d-flex justify-content-around align-items-center mt-2">
                  ...
                  <button type="button" className="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#ModalLogement">Voir plus</button>
                  {/* </div> */}
                </div>
              </div>
            </div>
